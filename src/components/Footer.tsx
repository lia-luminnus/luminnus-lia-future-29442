...
const Footer = () => {
  ...
  return <footer id="contato" className="relative border-t border-white/10 py-12 lg:py-16 overflow-hidden bg-[#0B0B0F]">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-white/70">Tecnologia e Inteligência que iluminam o futuro.</p>
            <div className="pt-4">
              <p className="text-sm font-semibold text-foreground mb-3">Newsletter</p>
              <form onSubmit={handleNewsletter} className="flex gap-2">
                <Input type="email" placeholder="Seu email" value={email} onChange={e => setEmail(e.target.value)} className="bg-background border-primary/30" />
        ...
        <div className="pt-8 border-t border-primary/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
            <p>© {new Date().getFullYear()} Luminnus — Tecnologia e Inteligência que iluminam o futuro.</p>
