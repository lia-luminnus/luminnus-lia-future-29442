...
export const AdminOverview = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-3xl font-bold tracking-tight text-purple-900">Visão Geral</h2>
              ...
              {monthlyGrowth?.map(([month, count]) => (
                <div key={month} className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="h-8 rounded-lg bg-gradient-to-r from-purple-500 to-purple-300" style={{ width: `${(count / (monthlyGrowth?.[0]?.[1] || 1)) * 100}%` }}>
      ...
      <Card>
        ...
        <CardContent className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <button className="rounded-lg border border-purple-200 bg-white p-4 text-left transition-all hover:border-purple-400 hover:shadow-md">
            <div className="font-semibold text-purple-900">Ver Logs</div>
            <div className="text-xs text-muted-foreground">Últimas atividades</div>
          </button>
          <button className="rounded-lg border border-purple-200 bg-white p-4 text-left transition-all hover:border-purple-400 hover:shadow-md">
            <div className="font-semibold text-purple-900">Backup DB</div>
            <div className="text-xs text-muted-foreground">Exportar dados</div>
          </button>
          <button className="rounded-lg border border-purple-200 bg-white p-4 text-left transition-all hover:border-purple-400 hover:shadow-md">
            <div className="font-semibold text-purple-900">Testar LIA</div>
            <div className="text-xs text-muted-foreground">Enviar comando</div>
          </button>
          <button className="rounded-lg border border-purple-200 bg-white p-4 text-left transition-all hover:border-purple-400 hover:shadow-md">
            <div className="font-semibold text-purple-900">Relatórios</div>
